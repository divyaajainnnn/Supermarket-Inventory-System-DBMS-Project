CREATE DATABASE IF NOT EXISTS supermarket_project;
...
CREATE TABLE supplier (
    ...
    supplied_store VARCHAR(5),
    PRIMARY KEY (supplier_id, sku_id),
    FOREIGN KEY (sku_id) REFERENCES sku(sku_id),
    FOREIGN KEY (supplied_store) REFERENCES store(store_id)
);
...
CREATE TABLE stock (
    ...
    stock_value DECIMAL(12,2) GENERATED ALWAYS AS (qty * inbound_price) STORED,
